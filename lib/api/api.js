...
module.exports = function(options) {
	 ...
	 */
		...
		app.get('/data/:current/album/:albumId', function(req, res, params) {
			console.log('GET album: ' + util.inspect(req.params));
			
			//do the actions
			var response = album.get(
				params.current == "@me" ? null : params.current,
				params.albumId ? params.albumId : null 
			);
			
			// return the response in the requested accept type
		 ...
		 */
		app.post('/data/:current/album/:parentAlbumId', connect.bodyParser(), function(req, res, params) {
		 ...
		 */
		app.put('/data/:current/album/:albumId', connect.bodyParser(), function(req, res, params) {
		 ...
		 */
		app.delete('/data/:current/album/:albumId', connect.bodyParser(), function(req, res, params) {
